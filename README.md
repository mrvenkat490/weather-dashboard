...
🌤 Weather Dashboard Hyderabad Get Weather Hyderabad, IN 📅 Monday 25 August, 2025 at 12:34 pm

🌡 Temperature: 29.85°C 🤔 Feels Like: 31.81°C ⬇ Min: 29.85°C | ⬆ Max: 29.85°C ☁ Condition: overcast clouds 💧 Humidity: 56% 🌬 Wind Speed: 7.64 m/s
...
bash Copy Edit cd server npm install npm run dev Install dependencies and start the frontend:

bash Copy Edit cd ../client npm install npm start Open your browser at http://localhost:3000

Make sure your .env file in server has your OpenWeatherMap API key:

env Copy Edit WEATHER_API_KEY=121c02d5c407e3183d3bce2ed9188710 📦 Usage Enter a city name and click Get Weather
